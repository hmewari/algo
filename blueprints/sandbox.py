    ...
    try:
        ...
        if config_key in [
            ...
            try:
                ...
                if config_key == "starting_capital":
                    if value < 1000:
                        return "Starting capital must be at least ₹1,000"
                    if value > 10000000:
                        return "Starting capital cannot exceed ₹1,00,00,000 (1 Crore)"
                    if not value.is_integer():
                        return "Starting capital must be a whole number (no decimals)"
